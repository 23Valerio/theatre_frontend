...
import { API_BASE_URL, API_SLIDER_ENDPOINT, API_SHOWS_ENDPOINT } from '../variables.js';
...
export async function createHome(app) {
    ...
    const theatre_shows_data = await fetchGetApiEndpointData(API_BASE_URL + API_SHOWS_ENDPOINT);
